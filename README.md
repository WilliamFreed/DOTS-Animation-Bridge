...
this lives on the Game Object holding your Animator.  You will need to assign an ***Animation_ParameterObject*** , as well as any curve controlled float values you want sent back to DOTS.
